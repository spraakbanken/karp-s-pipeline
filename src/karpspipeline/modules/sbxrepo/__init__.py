...
def export(config: PipelineConfig, module_data: dict[str, Any]) -> Sequence[Callable[[Entry], Entry]]:
    ...
    """
    from karpspipeline.modules.sbxrepo.metadata import _create_sb_metadata_file
...
def install(pipeline_config: PipelineConfig):
    from karpspipeline.modules.sbxrepo.common import _get_config
    from karpspipeline.modules.sbxrepo.installer import _upload_data, _install_metadata_file
